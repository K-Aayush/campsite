...
const ContactPage = () => {
  ...
  const contactPageStructuredData = generateStructuredData("ContactPage", {
    name: "Contact Mayur Wellness",
    description:
      "Get in touch with Mayur Wellness for wellness retreat bookings, inquiries, and support",
    mainEntity: {
      "@type": "Organization",
      name: "Mayur Wellness",
      telephone: contactInfo.contactPhone,
  ...
  return (
    <>
      <Head>
        <title>
          Contact Mayur Wellness - Get in Touch for Wellness Retreats
        </title>
        <meta
          name="description"
          content="Contact Mayur Wellness for wellness retreat bookings, inquiries about meditation programs, yoga classes, and nature therapy sessions. Get in touch with our expert team today."
        />
        <meta
          name="keywords"
          content="contact Mayur Wellness, wellness retreat booking, meditation program inquiry, yoga class booking, nature therapy contact, wellness center Nepal contact"
        />
        <link
          rel="canonical"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: contactPageStructuredData,
          }}
        />
      </Head>
      <div className="pt-16">
